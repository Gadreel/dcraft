...
dc.cms.edit = {
	...
	Loader: {
		getContext: function() {
			return dc.cms.edit.__context;
		},
		setContext: function(v) {
			dc.cms.edit.__context = v;
		},
		init: function(callback) {
			...
			itab.click(function (e) {
				if (callback)
					callback.call(dc.cms.edit.Loader);
				else
					dc.cms.edit.Loader.loadMenu();
			...
			if (!dc.handler || !dc.handler.cms || !dc.handler.cms.DisablePages) {
				if (dc.user.isAuthorized(['Editor', 'Admin'])) { 
					var sectbtn = $('<div class="ui-content dcuiPartButton"><i class="fa fa-cog"></i></div>');
				
					var peid = dc.cms.edit.Loader.addPopupMenu(dc.cms.edit.MenuEnum.PartPopup);
				
					sectbtn.click(function (e) {
						var pel = $(this).closest('*[data-dccms-mode="edit"]').get(0);
					
						dc.cms.edit.__context = {
							Menu: dc.cms.edit.MenuEnum.PagePart,
							Params: {
								Part: { 
				...
				if (dc.user.isAuthorized(['Editor', 'Admin'])) { 
					...
					var seid = dc.cms.edit.Loader.addPopupMenu(dc.cms.edit.MenuEnum.SectionPopup);
					...
					sectbtn.click(function (e) {
						...
						dc.cms.edit.__context = {
							Menu: dc.cms.edit.MenuEnum.PagePartSection,
							Params: {
								Part: { 
									Channel: $(pel).attr('data-dccms-channel'), 
									Path: $(pel).attr('data-dccms-path'), 
		...
		getPane: function() {
			...
			if (!pane) {
				...
				pane = new dc.cms.edit.Layer('#dcuiIntegratedPane', { Name: 'CMSPane' });
		...
		loadMenu: function() {
			var pane = dc.cms.edit.Loader.getPane();
			...
			if (!area && dc.cms.edit.__context && dc.cms.edit.__context.Menu)
				area = dc.cms.edit.__context.Menu;
			
			if (!area)
				area = dc.cms.edit.MenuEnum.PageProps;
			...
			var puid = dc.cms.edit.Loader.addPopupMenu(area);
			...
			node0.click(function(e) {
				...
				dc.cms.edit.Loader.loadPane(hpage);
			});
			...
			var addbMenu = function(mnu) {
				...
				node.click(mnu, function(e) {
					if (!dc.pui.Loader.busyCheck()) 
						e.data.Op.call(dc.cms.edit.Loader, e);
			...
			if (dc.cms.edit.Menu[area]) {
				for (var i = 0; i < dc.cms.edit.Menu[area].Menu.length; i++) 
					addbMenu(dc.cms.edit.Menu[area].Menu[i]);
			}
		...
		addPopupMenu: function(area, id) {
			...
			if (dc.cms.edit.Menu[area]) {
				for (var i = 0; i < dc.cms.edit.Menu[area].Menu.length; i++) 
					addpmenu(dc.cms.edit.Menu[area].Menu[i]);
			}
		...
		openPane: function(page, params, area) {
			var layer = dc.cms.edit.Loader.getPane();
			
			layer.clearHistory();
			
			dc.cms.edit.Loader.loadPane(page, params, area);
		},
		...
		destroy: function() {
			dc.cms.edit.Loader.closeAll(true);
			...
			Menu: [
				{
					...
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.openPane('/dcm/edit/page/Properties');
					}
				},
				{
					Title: 'Page Notes',
					Kind: 'Option',
					Op: function(e) {
						// TODO dc.cms.help.Loader.open('CMS-Editor', dc.cms.edit.MenuEnum.Start);
					}
				},
				{
					Title: 'More Options',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPane('/dcm/edit/More', null, dc.cms.edit.MenuEnum.More);
					}
				}
			],
			Help: {
			...
			Menu: [
				{
					...
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPane('/dcm/edit/page/Add-Page');
					}
				},
				{
					Title: 'Galleries',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPane('/dcm/edit/galleries/Browser', null, dc.cms.edit.MenuEnum.Gallery);
					}
				},
				{
					Title: 'Files',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPane('/dcm/edit/files/Browser');
					}
				}
			],
			Help: {
			...
			Menu: [
				{
					...
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPane('/dcm/edit/galleries/Add-Image');
					}
				},
				{
					Title: 'Quick Upload',
					Kind: 'Option',
					Op: function(e) {
						// TODO dc.cms.edit.Loader.loadPane('/dcm/edit/galleries/Add-Image');
					}
				},
				{
					Title: 'Add Folder',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPane('/dcm/edit/galleries/Add-Folder');
					}
				},
				{
					Title: 'Delete Folder',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPane('/dcm/edit/galleries/Delete-Folder');
					}
				},
				{
					Title: 'Variations',
					Kind: 'Option',
					Op: function(e) {
						// TODO dc.cms.edit.Loader.loadPane('/dcm/edit/galleries/Delete-Folder');
					}
				},
				{
					Title: 'Image Lists',
				...
				},
				{
					...
					Kind: 'Option',
					Op: function(e) {
						// TODO dc.cms.help.Loader.open('CMS-Editor', dc.cms.edit.MenuEnum.Gallery);
					}
				}
			],
			Help: {
			...
			Menu: [
				{
					...
					Kind: 'Option',
					Op: function(e) {
						//dc.cms.edit.Loader.loadPageInPane('/dcm/edit/galleries/Add-Folder');
				...
				},
				{
					...
					Kind: 'Option',
					Op: function(e) {
						//dc.cms.edit.Loader.loadPageInPane('/dcm/edit/galleries/Delete-Folder');
			...
			Menu: [
				{
					...
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPageInPane('/dcm/edit/files/Add-File');
					}
				},
				{
					Title: 'Add Folder',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPageInPane('/dcm/edit/files/Add-Folder');
					}
				},
				{
					Title: 'Delete Folder',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPageInPane('/dcm/edit/files/Delete-Folder');
					}
				}
			],
			Help: {
		...
		dcmFileDetail: {
			Menu: [
				...
				},
				{
					...
					Kind: 'Option',
					Op: function(e) {
						//dc.cms.edit.Loader.loadPageInPane('/dcm/edit/files/Delete-File');
				...
				},
				{
					...
					Op: function(e) {
						...
						dc.cms.edit.Loader.loadPageInPane('/dcm/edit/files/Edit-Text-File');
					}
				}
			],
			Help: {
			...
			Menu: [
				{
					...
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPageInPane('/dcm/edit/page/Add-Page');
					}
				},
				{
					Title: 'Add Folder',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.loadPageInPane('/dcm/edit/page/Add-Folder');
					}
				/*
				},
				{
					...
					Op: function(e) {
						...
						dc.cms.edit.Loader.loadPageInPane('/dcm/edit/page/Delete-Folder');
					}
				},
				{
					Title: 'Help',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.help.Loader.open('CMS-Editor', dc.cms.edit.MenuEnum.Pages);
					}
				*/
				}
			],
		...
		dcmPageProps: {
			Menu: [
				...
				},
				{
					...
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.openPane('/dcm/edit/galleries/Browser');
					}
				},
				{
					Title: 'Files',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.openPane('/dcm/edit/files/Browser');
					}
				},
				{
					Title: 'Sign Out',
			...
			Menu: [
				{
					...
					Auth: [ 'Developer' ],
					Op: function(e) {
						dc.cms.edit.Loader.openPane('/dcm/edit/page/Edit-Part-Content');
					}
				}
			],
			Help: {
			...
			Menu: [
				{
					...
					Kind: 'Option',
					Op: function(e) {
					    var params = dc.cms.edit.Loader.getContext().Params;
				...
				},
				{
					...
					Op: function(e) {
					    ...
					    dc.cms.edit.Loader.getContext().Menu = dc.cms.edit.MenuEnum.Empty;
					    dc.cms.edit.Loader.getContext().IsNew = true;
						
						dc.cms.edit.Loader.openPane('/dcm/edit/page/Insert-Section');
					}
				}
			],
			Help: {
			...
			Menu: [
				...
				},
				{
					...
					Op: function(e) {
						...
						dc.cms.edit.Loader.openPane('/dcm/edit/page/Edit-Section-Prop-' + params.Section.Plugin);
					}
				}
			],
			Help: {
			...
			Menu: [
				{
					...
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.openPane('/dcm/edit/page/Edit-Section-Gallery');
					}
				},
				{
					Title: 'Template',
					Kind: 'Option',
					Op: function(e) {
						dc.cms.edit.Loader.openPane('/dcm/edit/page/Edit-Section-Template');
					}
				},
				{
					Title: 'Properties',
			...
			Menu: [
				{
					...
					Op: function(e) {
					    ...
					    if ($sect.hasClass('dc-section-gallery')) {
							dc.cms.edit.Loader.getContext().Menu = dc.cms.edit.MenuEnum.PagePartGallerySection;
...
dc.cms.edit.Layer = function(contentsel, options) {
	this.init(contentsel, options);
};  

dc.cms.edit.Layer.prototype = new dc.pui.Layer();

dc.cms.edit.Layer.prototype.manifestPage = function(entry, killpane) {
	var layer = this;
...
dc.cms.edit.Layer.prototype.clearHistory = function() {
	dc.pui.Layer.prototype.clearHistory.call(this);
	
	$(this.__content).empty();
};

dc.cms.edit.Layer.prototype.back = function() {
...
dc.cms.edit.Layer.prototype.enhancePage = function() {
	var layer = this;
...
dc.cms.edit.Layer.prototype.close = function() {
	$(this.__content).hide();
	dc.cms.edit.Loader.closeAll();
};


dc.cms.edit.Layer.prototype.scrollPage = function(selector) {
	$("#" + this.__current.__cmsid).animate({ scrollTop: $(selector).get(0).getBoundingClientRect().top + window.pageYOffset }, "fast");
};


/*
dc.cms.edit.Layer.prototype.init = function(contentsel, options) {
