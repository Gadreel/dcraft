 ...
 */
package dcraft.work.sql;

import dcraft.hub.Hub;
import dcraft.lang.op.FuncResult;
import dcraft.lang.op.OperationContext;
import dcraft.lang.op.OperationResult;
import dcraft.sql.SqlEngine;
import dcraft.sql.SqlNull;
import dcraft.sql.SqlSelect;
import dcraft.sql.SqlSelectInteger;
import dcraft.sql.SqlSelectSqlDateTime;
...
import dcraft.work.IQueueDriver;
...
public class QueueDriver implements IQueueDriver {
	...
	public FuncResult<Task> loadWork(RecordStruct info) {
		...
		Task tb = Task.taskFromRecord(rec.getFieldAsRecord("Task"))
			.withWorkId(workid + "")
