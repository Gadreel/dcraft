package dcraft.json3.base;

import static dcraft.json3.JsonTokenId.*;

import java.io.*;

import dcraft.json3.Base64Variant;
import dcraft.json3.JsonToken;
import dcraft.json3.io.CharTypes;
import dcraft.json3.io.IOContext;
import dcraft.json3.util.ByteArrayBuilder;
import dcraft.json3.util.TextBuffer;
...
public class ReaderBasedJsonParser extends ParserBase
{
     ...
     */
    public ReaderBasedJsonParser(IOContext ctxt, Reader r)
    {
        super(ctxt);
        _reader = r;
    ...
    */
    ...
    protected final String _parseName() throws IOException
    {
        ...
        while (ptr < _inputEnd) {
            ...
            if (ch < codes.length && codes[ch] != 0) {
                if (ch == '"') {
                    ...
                    return this.findSymbol(_inputBuffer, start, ptr - start);
                }
                break;
            }
        ...
        int start = _inputPtr;
        _inputPtr = ptr;
        return _parseName2(start, INT_QUOTE);
    }

    private String _parseName2(int startPtr, int endChar) throws IOException
    {
        ...
        _textBuffer.setCurrentLength(outPtr);
        {
            ...
            return this.findSymbol(buf, start, len);
        }
    }
    ...
    protected String _handleOddName(int i) throws IOException
    {
        ...
        _inputPtr = ptr;
        return _handleOddName2(start, codes);
    }
    ...
    private String _handleOddName2(int startPtr, int[] codes) throws IOException
    {
        _textBuffer.resetWithShared(_inputBuffer, startPtr, (_inputPtr - startPtr));
        char[] outBuf = _textBuffer.getCurrentSegment();
        int outPtr = _textBuffer.getCurrentSegmentSize();
