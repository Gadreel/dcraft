...
import dcraft.web.mdx.process.Block;
import dcraft.web.mdx.process.BlockType;
import dcraft.web.mdx.process.Emitter;
import dcraft.web.mdx.process.Line;
import dcraft.web.mdx.process.LineType;
import dcraft.web.mdx.process.LinkRef;
import dcraft.web.mdx.process.Utils;
...
public class Processor {
    public static XElement process2(WebContext ctx, Reader reader, Configuration configuration) throws IOException {
    	try {
    ...
    public static XElement process2(WebContext ctx, String input, Configuration configuration) throws IOException {
    	try (StringReader in = new StringReader(input)) {
    		return process2(ctx, in, configuration);
    	}
    }
