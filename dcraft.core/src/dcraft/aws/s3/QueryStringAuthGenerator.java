...
public class QueryStringAuthGenerator {
    ...
    public String getBucketLogging(String bucket, Map<String,List<String>> headers) {
        Map<String,String> pathArgs = new HashMap<>();
        pathArgs.put("logging", null);
        return generateURL("GET", bucket, "", pathArgs, headers);
    }

    public String putBucketLogging(String bucket, String loggingXMLDoc, Map<String,List<String>> headers) {
        Map<String,String> pathArgs = new HashMap<>();
        pathArgs.put("logging", null);
        return generateURL("PUT", bucket, "", pathArgs, headers);
    }
    ...
    private String generateURL(String method, String bucketName, String key, Map<String,String> pathArgs, Map<String,List<String>> headers) 
    {
        long expires = 0L;
