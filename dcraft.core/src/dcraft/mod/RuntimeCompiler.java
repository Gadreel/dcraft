 ...
 * 															// also OK
 * JavaStringCompiler&lt;Object&gt; compiler = new JavaStringCompiler&lt;MyInterface&gt;(
 * 		classLoader, null);
 * try {
...
public class RuntimeCompiler<T> {
	...
	// TODO replace with Bundle, Bundle file
	...
	// TODO replace with runtimecompiler
	 ...
	 */
	public RuntimeCompiler(Bundle loader, Iterable<String> options) {
		...
		// TODO
		final JavaFileManager fileManager = new RuntimeCompilerManager(loader, stdfileManager);
	 ...
	 *             <var>types</var>.
	 */
	public synchronized Class<T> compile(final String qualifiedClassName, final CharSequence javaSource, final DiagnosticCollector<JavaFileObject> diagnosticsList, final Class<?>... types) throws RuntimeCompilerException, ClassCastException {
	 ...
	 */
	public synchronized Map<String, Class<T>> compile(final Map<String, CharSequence> classes, final DiagnosticCollector<JavaFileObject> diagnosticsList) throws RuntimeCompilerException {
		...
		if (result == null || !result.booleanValue()) {
			throw new RuntimeCompilerException("Compilation failed.",
		...
		try {
			...
			throw new RuntimeCompilerException(classes.keySet(), e, diagnostics);
		} 
...
final class FileManagerImpl extends ForwardingJavaFileManager<JavaFileManager> {
	...
	private URI uri(Location location, String packageName, String relativeName) {
		return RuntimeCompiler.toURI(location.getName() + '/'
