...
public class FeedAdapter {
	...
	public void buildHtmlPageUI(IOutputContext wctx, UIElement frag) {
		this.buildHtmlPageUI(wctx, OperationContext.get(), frag);
	}
	
	public void buildHtmlPageUI(IOutputContext wctx, ITranslationAdapter ctx, UIElement frag) {
	...
	public void buildHtmlPage(IOutputContext wctx, XElement frag) {
		this.buildHtmlPage(wctx, OperationContext.get(), frag);
	}
	
	public void buildHtmlPage(IOutputContext wctx, ITranslationAdapter ctx, XElement frag) {
		OperationResult or = new OperationResult();
	...
	public XElement buildHtml(IOutputContext wctx, String id, String clss, XElement altsrc) {
		return this.buildHtml(wctx, OperationContext.get(), id, clss, altsrc);
	}
	
	public XElement buildHtml(IOutputContext wctx, ITranslationAdapter ctx, String id, String clss, XElement altsrc) {
	...
	public XElement buildHtmlPart(IOutputContext wctx, ITranslationAdapter ctx, MatchResult mr, String id, String clss) {
	...
	public String getPartValue(IOutputContext wctx, ITranslationAdapter ctx, MatchResult mr) {
		if ((ctx == null) || (mr == null))
			return null;
	...
	public XElement getPartXml(IOutputContext wctx, ITranslationAdapter ctx, MatchResult mr) {
		if ((ctx == null) || (mr == null))
			return null;
