...
public class FolderListingOld implements IStoredProc {
	@Override
	public void execute(DatabaseInterface conn, DatabaseTask task, OperationResult log) {
		long st = System.currentTimeMillis();
		
		System.out.println("starting folder listing at " + st);
		...
		System.out.println("ending folder listing at " + et + " took " + (et - st));
