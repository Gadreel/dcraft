...
public class FileMatcherNameFilter extends FileMatcher {
	...
	public FileMatcherNameFilter withPattern(Pattern v) {
		this.pattern = v;
		return this;
	}
	
	public FileMatcherNameFilter withStartsWith(String v) {
		this.startsWith = v;
		return this;
	}
	
	public FileMatcherNameFilter withEndsWith(String v) {
		this.endsWith = v;
		return this;
	}
