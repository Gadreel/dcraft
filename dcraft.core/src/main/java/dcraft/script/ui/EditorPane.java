...
public class EditorPane extends JRootPane implements SyntaxConstants, IDebugger {
	...
	public EditorPane() {
		...
		ImageIcon pbicon = new ImageIcon(this.getClass().getResource("/dcraft/script/ui/media-playback-start.png"), "Run script");
		ImageIcon psicon = new ImageIcon(this.getClass().getResource("/dcraft/script/ui/media-playback-stop.png"), "Stop script");
		ImageIcon sficon = new ImageIcon(this.getClass().getResource("/dcraft/script/ui/media-seek-forward.png"), "Step into script");		
	...
	private class AboutAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(EditorPane.this,
					...
					"<br>Version 0.8.1" +
					"<br><a href=\"http://designcraft.io/\">dcraft.com</a>" +
