...
public class SelectRequest extends DataRequest {
	...
	public SelectRequest(String table, SelectFields select) {
		this(table, select, null, null, null, (BigDateTime)null);
	}
	
	public SelectRequest(String table, SelectFields select, OrderFields order) {
		this(table, select, order, null, null, (BigDateTime)null);
	}
	
	public SelectRequest(String table, SelectFields select, WhereExpression where) {
		this(table, select, null, where, null, (BigDateTime)null);
	}
	
	public SelectRequest(String table, SelectFields select, OrderFields order, WhereExpression where) {
		this(table, select, order, where, null, (BigDateTime)null);
	}
	
	public SelectRequest(String table, SelectFields select, OrderFields order, WhereExpression where, ICollector collector) {
		this(table, select, order, where, collector, (BigDateTime)null);
	}
	
	public SelectRequest(String table, SelectFields select, OrderFields order, WhereExpression where, BigDateTime when) {
		this(table, select, order, where, null, when);
	}
	
	public SelectRequest(String table, SelectFields select, OrderFields order, WhereExpression where, DateTime when) {
		this(table, select, order, where, null, (when != null) ? new BigDateTime(when) : null);
	}
	
	public SelectRequest(String table, SelectFields select, OrderFields order, WhereExpression where, ICollector collector, DateTime when) {
		this(table, select, order, where, collector, (when != null) ? new BigDateTime(when) : null);
	}
	
	public SelectRequest(String table, SelectFields select, OrderFields order, WhereExpression where, ICollector collector, BigDateTime when) {
		super("dcSelect");
