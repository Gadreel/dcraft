...
public class AWSAuthConnection {
     ...
     */
    public Response createBucket(String bucket, String location, Map<String,List<String>> headers)
        throws MalformedURLException, IOException
    {
        String body;
        if (location == null) {
     ...
     */
    public Response copy( String sourceBucket, String sourceKey, String destinationBucket, String destinationKey, Map<String,List<String>> headers )
    throws MalformedURLException, IOException
    {
     ...
     * headers to pass (can be null).  You may wish to set the x-amz-acl header appropriately.
     */
    public Response copy( String sourceBucket, String sourceKey, String destinationBucket, String destinationKey, Map<String,List<String>> metadata, Map<String,List<String>> headers )
    throws MalformedURLException, IOException
    {
     ...
     * headers to pass (can be null).
     */
    public GetResponse getBucketRequestPayment(String bucket, Map<String,List<String>> headers)
        throws MalformedURLException, IOException
    {
     ...
     * headers to pass (can be null).
     */
    public Response putBucketRequestPayment(String bucket, String requestPaymentXMLDoc, Map<String,List<String>> headers)
        throws MalformedURLException, IOException
    {
        Map<String,String> pathArgs = new HashMap<>();
        pathArgs.put("requestPayment", null);
     ...
     * headers to pass (can be null).
     */
    public GetResponse getBucketLogging(String bucket, Map<String,List<String>> headers)
        throws MalformedURLException, IOException
    {
        Map<String,String> pathArgs = new HashMap<>();
     ...
     * headers to pass (can be null).
     */
    public Response putBucketLogging(String bucket, String loggingXMLDoc, Map<String,List<String>> headers)
        throws MalformedURLException, IOException
    {
        Map<String,String> pathArgs = new HashMap<>();
        pathArgs.put("logging", null);
     ...
     * @throws IOException
     */
    private HttpURLConnection makeRequest(String method, String bucketName, String key, Map<String,String> pathArgs, Map<String,List<String>> headers)
        throws MalformedURLException, IOException
    {
     ...
     */
    private HttpURLConnection makeRequest(String method, String bucket, String key, Map<String,String> pathArgs, Map<String,List<String>> headers,
                                          S3Object object)
        throws MalformedURLException, IOException
    {
