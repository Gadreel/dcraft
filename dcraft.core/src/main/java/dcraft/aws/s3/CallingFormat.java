...
public abstract class CallingFormat {
    ...
    public abstract URL getURL (boolean isSecure, String server, int port, String bucket, String key, Map<String,String> pathArgs)
    ...
    static private class PathCallingFormat extends CallingFormat {
        ...
        public URL getURL(boolean isSecure, String server, int port, String bucket, String key, Map<String,String> pathArgs) 
        throws MalformedURLException {
