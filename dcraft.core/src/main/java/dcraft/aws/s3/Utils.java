...
public class Utils {
     ...
     */
    static String makeCanonicalString(String method, String bucketName, String key, Map<String,String> pathArgs, 
                                ...
                                boolean urlencode)
    {
        ...
        String b64 = dcraft.util.Base64.encodeToString(mac.doFinal(canonicalString.getBytes()), true);
