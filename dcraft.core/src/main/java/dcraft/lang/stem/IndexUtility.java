...
#
************************************************************************ */
package dcraft.lang.stem;

import java.util.HashSet;
import java.util.Set;

import dcraft.lang.StringBuilder32;
import dcraft.lang.stem.English;
	...
	*/
	...
	static public void stemEnglishPhraseAppend(CharSequence phrase, int score, IndexInfo info) {
        ...
        for (int i = 0; i < phrase.length(); i++) {
        	...
        	// https://github.com/Gadreel/divconq/blob/086c03af97018d496f35e712e8b75dfa394a431c/dcraft.core/src/main/java/divconq/lang/stem/IndexUtility.java
