 ...
 *  
 *  	&lt;Clock TimerClass="dcraft.util.BasicSettingsObfuscator" ... /&gt;
 *  
...
public interface ISettingsObfuscator {
	 ...
	 * @return hash as hex string
	 */
	String hashPassword(CharSequence v);
	
	/**
	 * Check a password
	 * 
	 * @param candidate raw value to be checked
	 * @param hash value to compare with
	 * @return true if password is valid
	 */
	boolean checkHexPassword(CharSequence candidate, CharSequence hash);
}
