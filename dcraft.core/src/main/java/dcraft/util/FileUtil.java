...
public class FileUtil {
    ...
    public static FuncResult<Integer> copyFileTree(Path source, Path target) {
    	return copyFileTree(source, target, null);
    }
    
    public static FuncResult<Integer> copyFileTree(Path source, Path target, Predicate<Path> filter) {
    	FuncResult<Integer> or = new FuncResult<>();
			        ...
			        new SimpleFileVisitor<Path>() {
			                ...
			                throws IOException
			            {
			                ...
			                try {
			                    ...
			                    cnt.incrementAndGet();  // TODO not sure if this is correct
			                } 
			                catch (FileAlreadyExistsException x) {
