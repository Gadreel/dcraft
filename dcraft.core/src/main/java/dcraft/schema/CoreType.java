...
public class CoreType {
	...
	public String getClassName() {
		...
		if (this.root == RootType.String)
			return "dcraft.struct.scalar.StringStruct";
		
		if (this.root == RootType.Number) 
			return "dcraft.struct.scalar.DecimalStruct";
		
		if (this.root == RootType.Binary) 
			return "dcraft.struct.scalar.BiaryStruct";
		
		if (this.root == RootType.Boolean)
			return "dcraft.struct.scalar.BooleanStruct";
		
		if (this.root == RootType.Null) 
			return "dcraft.struct.scalar.NullStruct";
		
		return "dcraft.struct.scalar.AnyStruct";
	}
