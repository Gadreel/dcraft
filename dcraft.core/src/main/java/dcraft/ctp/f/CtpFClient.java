...
import dcraft.ctp.stream.CtpStreamDest;
import dcraft.ctp.stream.CtpStreamSource;
import dcraft.ctp.stream.FileSourceStream;
import dcraft.ctp.stream.FolderDumpStream;
import dcraft.ctp.stream.IStream;
...
import dcraft.filestore.select.FileSelectionMode;
...
public class CtpFClient extends CtpClient {
	...
	public void writeFrom(OperationCallback cb, IStream... strm) {
		...
		Task t = Task.taskWithSubContext()
		...
		t.withWork(StreamUtil.composeStream(tstrm));
		
		this.currTask = new TaskRun(t);
